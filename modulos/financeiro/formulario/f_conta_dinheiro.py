from lib.xpath.criar_placeholder import ENTRE_COM_A_DESCRICAO, SALDO_INCIAL, PESQUISAR, SELECIONE
from lib.dsl.liguagem import *
from lib.xpath.criar_xpath_botao import SALVAR, CANCELAR
from modulos.financeiro.elemento.e_conta_dinheiro import COMBO_SITUACAO, SELECIONAR_SITUACAO
